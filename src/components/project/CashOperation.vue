    ...
    <div class="form-box">
      <el-form ref="form" :model="form" label-width="80px">
        ...
        <el-form-item label="支付渠道">
          <el-select v-model="form.payChannel" placeholder="请选择">
            <el-option key="bbk" label="xendit" :value="-99"> </el-option>
            <el-option key="xtc" label="bluepay" :value="-88"> </el-option>
          </el-select>
        </el-form-item>
  ...
  export default {
    ...
    methods: {
      onSubmit() {
        ...
        let payChannel = self.form.payChannel;
        ...
        self.isActive = true;
        self.getData(loanId, userId, bankNo, bankCode, bankHolderName, amount, payChannel, description);


      },
      getData(loanId, userId, bankNo, bankCode, bankHolderName, amount, payChannel, description) {
        let self = this;
