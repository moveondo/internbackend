<template>
  <div id="app">
    ...
    <div class="trans">
      <span @click="bigImg()">放大
        <i class="el-icon-zoom-in"></i>
      </span>
      <span @click.stop="showBigImg=!showBigImg">缩小
        <i class="el-icon-zoom-out"></i>
      </span>
      <span @click="TransImg()">旋转
...
<script>
  export default {
    ...
    created() {
      ...
      this.KTPNO = KTPNO;
      console.log(imgURL, KTPname, KTPNO)　　 //console.log(this.$refs.IMG.style.cssText)
      　　
    },
    methods: {
      bigImg(index) {
