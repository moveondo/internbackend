<template>
  <div class="login-wrap">
    <div class="ms-title">Sistem manajemen kantor belakang</div>
    <div class="ms-login">
    ...
    data: function () {
      return {
        ...
        rules: {
          username: [{
            required: true,
            message: 'Mohon masukan nomor handphone',
            trigger: 'blur'
          }],
          password: [{
            required: true,
            message: 'Mohon masukan sandi',
            trigger: 'blur'
          }]
        }
      }
      ...
      submitForm(formName) {
        ...
        self.$axios.post(self.url, {
          ...
          if (res.data.result == 0) {
            ...
            //FunctionUrl=res.data.content.functionList;
            console.log("FunctionUrl" + res.data.content.functionList);
            self.$store.commit('ChangeFunction', FunctionUrl);
